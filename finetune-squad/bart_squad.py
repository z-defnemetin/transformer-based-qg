...
for epoch in range(epochs):
    ...
    model.save_pretrained(f'/home4/s4236599/speedrun_trial/bart/epoch{epoch+1}_testloss:{test_loss}')
loss_df = pd.DataFrame(list(zip(train_loss_his, test_loss_his)))
loss_df.to_csv("/home4/s4236599/speedrun_trial/bart_loss.csv", index = False)
