...
for epoch in range(epochs):
    ...
    print(f"Epoch {epoch+1} - Eval Loss: {test_loss}")
    
    
    train_loss_his.append(train_loss)
    test_loss_his.append(test_loss)
    model.save_pretrained(f'/home4/s4236599/speedrun_trial/pegasus/epoch{epoch+1}_{test_loss}')
loss_df = pd.DataFrame(list(zip(train_loss_his, test_loss_his)))
loss_df.to_csv("/home4/s4236599/speedrun_trial/pegasus_loss.csv", index = False)
