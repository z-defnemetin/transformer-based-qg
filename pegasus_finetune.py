...
train_encodings = tokenizer(train_source, truncation = True, padding=True)
...
model.save_pretrained(f'/home4/s4236599/pegasus_models/pegasus_epoch{epoch+1}')
loss_df = pd.DataFrame(list(zip(learning_rate, train_loss_his, test_loss_his)))
loss_df.to_csv("/home4/s4236599/pegasus_loss_final.csv", index = False)
