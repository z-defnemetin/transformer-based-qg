...
train_encodings = tokenizer(train_source, truncation = True, max_length = 512, padding=True)
train_decodings = tokenizer(train_target, truncation = True, max_length = 256, padding=True)

test_encodings = tokenizer(test_source, truncation = True, max_length = 512, padding=True)
test_decodings = tokenizer(test_target, truncation = True, max_length = 256, padding=True)
